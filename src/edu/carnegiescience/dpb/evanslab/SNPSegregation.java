    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i=aMin; i<=aMax; i++) {
                ...
                if (file.exists()) {
                    ...
                    while((line=reader.readLine())!=null) {
                        ...
                        String key = rec.chr+"\t"+String.format("%10d", rec.pos1); // clump different alleles together (fairly rare)
                        ...
                        } else if (keep && rec.isHeterozygous()) {
            ...
            for (String key : keySet) {
                ...
                // output
                System.out.println(contig+"\t"+position+"\t"+aRefReads+"\t"+aAltReads+"\t"+aHet+"\t"+aHom+"\t"+bRefReads+"\t"+bAltReads+"\t"+bHet+"\t"+bHom);
            }
