 ...
 *   -g --gffFile  GFF file showing location of the genes on the genome of interest
 *   -v --vcfFile  VCF file showing SNPs on the genome of interest
...
public class SNPReadCounter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // output header
        System.out.println("Gene\tSeq\tStart\tEnd\tStrand\tCount\tRF\tRR\tAF\tAR");
        ...
        while ((line=reader.readLine())!=null) {
            ...
            for (FeatureI feature : genes) {
                ...
                if (count>0) {
                    System.out.println(gene+"\t"+seq+"\t"+start+"\t"+end+"\t"+strand+"\t"+count+"\t"+refForward+"\t"+refReverse+"\t"+altForward+"\t"+altReverse);
                }
            }
        }
